        ...
        <div class="profile">
          ...
          <div class="create-post">
            ...
            <form @submit.prevent="createPost">
              ...
              <button class="button" :disabled="post.content === ''">post</button>
            </form>
          </div> <!-- /.create-post -->
        </div> <!-- /.profile -->
      </div> <!-- /.col1 -->
      <div class="col2">
        <transition name="fade">
          <div v-if="hiddenPosts.length" @click="showNewPosts" class="hidden-posts">
            <p>Click to show <span class="new-posts">{{ hiddenPosts.length }}</span> new <span v-if="hiddenPosts.length > 1">posts</span><span v-else>post</span>
            </p>
          </div>
        </transition>
      ...
      <div v-if="showPostModal" class="p-modal">
        <div class="p-container">
          ...
          <div v-show="postComments.length" class="comments">
            <div v-for="comment in postComments" v-bind:key="comment.id" class="comment">
